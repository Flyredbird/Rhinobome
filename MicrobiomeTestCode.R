...
# Load Data Files
setwd("~/Desktop/bioinformatic_analysis/FullPopulationResults1") # set file directory location
...
# Rarefy dataset
input_RhinoAdult = single_rarefy(input_RhinoAdult,40034) 
#29 samples remain, lost 61FFeb
